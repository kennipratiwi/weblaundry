...
// agar tidak bisa login jika tidak memiliki username dan password
?> 
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/admin_user.png" class="user-image img-responsive"/>
					</li>
				
					
                    <li><a href="index.php"><i class="fa fa-dashboard"></i> Beranda</a></li>
                    <li><a href="index.php?halaman=produk"><i class="fa fa-cube"></i> Layanan</a></li>
                    <li><a href="index.php?halaman=pemesanan"><i class="fa fa-shopping-cart"></i> Pemesanan</a></li>
                    <li><a href="index.php?halaman=laporan_pemesanan"><i class="fa fa-file"></i> Laporan Pemesanan</a></li>
